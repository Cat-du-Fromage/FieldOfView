...
//     version 1.8.2
//     from Assets/RTTCamera/1_InputSystem/Controls.inputactions
//
...
public partial class @Controls: IInputActionCollection2, IDisposable
{
    ...
    ~@Controls()
    {
        Debug.Assert(!m_CameraControl.enabled, "This will cause a leak and performance issues, Controls.CameraControl.Disable() has not been called.");
        Debug.Assert(!m_SelectionRectangle.enabled, "This will cause a leak and performance issues, Controls.SelectionRectangle.Disable() has not been called.");
    }
